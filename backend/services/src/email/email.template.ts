export const EmailTemplates = {
  ...
  USER_CREATE: {
    ...
    html: `
        ...
        Your account has been created for the {{countryName}} Climate Transparency Platform. You can access your account using the
        ...
        Sincerely, <br>
        The {{countryName}} Climate Transparency Platform Team <br><br>
        `,
    text: "",
  },
  API_KEY_EMAIL: {
  ...
  CHANGE_PASSWORD: {
    ...
    html: `
        Hi {{name}},<br><br>
        The password of your {{countryName}} Climate Transparency Platform account was changed successfully. <br><br>
        If you do not use {{countryName}} Climate Transparency Platform, please ignore this email.

        <br><br>
        Sincerely, <br>
        The {{countryName}} Climate Transparency Platform Team
        `,
    text: "",
  },
    ...
    html: `
        Hi {{name}},<br><br>
        Password of Your {{countryName}} Climate Transparency Platform account has been changed by the Super Admin. <br><br>

        Your new password: {{newPassword}}  <br><br>

				Please enter your email and new password to access your {{countryName}} Climate Transparency Platform account. 
  ...
  FORGOT_PASSOWRD: {
    ...
    html: `
        Hi {{name}},<br><br>
        We received a request to reset your {{countryName}} Climate Transparency Platform account password. <br><br>
  ...
  USER_REACTIVATED: {
    ...
    html: `
        Hi {{name}},<br><br>
        Your {{countryName}} Climate Transparency Platform account has been reactivated by the {{government}}. 
  ...
  USER_DEACTIVATED: {
    ...
    html: `
        Hi {{name}},<br><br>
        Your {{countryName}} Climate Transparency Platform account has been deactivated by the {{government}} with the following remark(s):
        {{remarks}}<br><br>
